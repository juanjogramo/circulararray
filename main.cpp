...
int main() {
    ...
    ASSERT(array->array_to_string() == "2 10 6 3 7 8 1", "The function push_front is not working");
    array->pop_front(); 
    array->pop_front(); 
    array->pop_front(); 
    array->push_back(15);
    ...
    array->sort();
    ASSERT(array->array_to_string() == "1 3 4 7 8 9 15", "The function sort is not working");
    array->reverse();
    ASSERT(array->array_to_string() == "15 9 8 7 4 3 1", "The function reverse is not working");   
    array->insert(10, 1);       
    array->pop_back();  
